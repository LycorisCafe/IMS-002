...
<nav class="navbar bg-body-tertiary">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">SFT තක්සලාව</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body">
                <div class="d-grid gap-2">
                    <a class="btn btn-primary btn-sm" aria-current="page" href="../req/dashboard.php">Dashboard</a>
                    <a class="btn btn-primary btn-sm" aria-current="page" href="../req/newStudent1.php">Add a New Student</a>
                    <a class="btn btn-primary btn-sm" aria-current="page" href="../req/newStudent1.php">Exams</a>
                    <a class="btn btn-primary btn-sm" aria-current="page" href="../req/newStudent1.php">New Classes</a>
